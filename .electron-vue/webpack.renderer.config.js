...
let rendererConfig = {
  ...
  entry: {
    ...
    posOri: path.join(__dirname, '../src/renderer/posOri.js'),
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: 'index.html',
      title: 'Geppetto',
      template: path.resolve(__dirname, '../src/puppet.ejs'),
      chunks: ['renderer'],
      minify: {
  ...
  resolve: {
    alias: {
      ...
      '@styl': path.join(__dirname, '../src/renderer/styl')
    },
